...
private class MyTapGestureRecognizer: UITapGestureRecognizer {
    var action : (()->Void)? = nil
}
...
extension UIView{
    ...
    func  addSwipeGesture(_ type:UISwipeGestureRecognizer.Direction,_ action : @escaping ()->Void ){
        self.endEditing(true)
        let swipe = MySwipeGestureRecognizer(target: self , action: #selector(self.handleSwipe(_:)))
        swipe.action = action
    ...
    @objc func handleSwipe(_ sender: MyTapGestureRecognizer) {
        sender.action!()
    }
